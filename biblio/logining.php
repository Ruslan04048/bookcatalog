    ...
    <div class="second">
        ...
        <h1>Вход</h1>
            ...
            <div class="second__btns">
                ...
                <input type="submit" value="Войти" class="second__sbm" disabled id="btn">
            </div>
            <p>Нажимая Войти вы соглашаетесь с <a href="">политикой конфиденциальности и пользовательским соглашением</a></p>
        </form>
    </div>
